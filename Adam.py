...
class WGD_Adam(Optimizer):
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        super(WGD_Adam , self).__init__(params, defaults)

    def __setstate__(self, state):
        super(WGD_Adam , self).__setstate__(state)
...
class WGD_Adam2(Optimizer):
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        defaults = dict(lr=lr, betas=betas, eps=eps,
                        weight_decay=weight_decay, amsgrad=amsgrad)
        super(WGD_Adam2, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(WGD_Adam2, self).__setstate__(state)
        for group in self.param_groups:
            group.setdefault('amsgrad', False)
